		...
		<form id="devFrm" method="post" action="${path }/demo/updatedemoend.do">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					<input class="form-check-input" type="radio" name="devGender" id="devGender0" value="M" ${fn:contains(demo.devGender,'M')?"checked":"" }>
					<label class="form-check-label" for="devGender0">남</label>
					</div>
					<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="devGender" id="devGender1" value="F" ${fn:contains(demo.devGender,'F')?"checked":"" }>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<div class="form-check form-check-inline">
					<input class="form-check-input" type="checkbox" name="devLang" id="devLang0" value="Java" ${fn:join(demo.devLang,",").contains("Java")?"checked":"" }>
					<label class="form-check-label" for="devLang0">Java</label>
					</div>
					<div class="form-check form-check-inline">
					<input class="form-check-input" type="checkbox" name="devLang" id="devLang1" value="C" ${fn:join(demo.devLang,",").contains("C")?"checked":"" }>
					<label class="form-check-label" for="devLang1">C</label>
					</div>
					<div class="form-check form-check-inline">
					<input class="form-check-input" type="checkbox" name="devLang" id="devLang2" value="Javascript" ${fn:join(demo.devLang,",").contains("Javascript")?"checked":"" }>
