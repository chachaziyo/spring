			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					...
					<c:if test="${sessionScope.loginMember != null }">
						<span>
							<a href="${path }/member/memberList.do?userId=${loginMember.userId}"><c:out value="${loginMember.userName }"/>님 ,</a>환영합니다^^
						</span>
						<button class="btn btn-outline-success my-2 my-sm-0" onclick="location.replace('${path}/member/logout.do');">로그아웃</button>
					</c:if>
				</div>
			</nav>	
		</header>
